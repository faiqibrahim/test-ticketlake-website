...
function initCitybook() {
    ...
    $('input[name="homePage-input-search"]').daterangepicker({
        autoUpdateInput: false,
        parentEl: $(".homePage-date-parent"),
        locale: {
            cancelLabel: 'Clear'
        }
    });
    $('input[name="homePage-input-search"]').on('apply.daterangepicker', function (ev, picker) {
        $(this).val(picker.startDate.format('MM/DD/YYYY') + ' - ' + picker.endDate.format('MM/DD/YYYY'));
    });
    $('input[name="homePage-input-search"]').on('cancel.daterangepicker', function (ev, picker) {
        $(this).val('');
    });
    $('input[name="homePage-input-search_slider"]').daterangepicker({
        autoUpdateInput: false,
        drops: "up",
        parentEl: $(".homePage-date-parent3"),
        locale: {
            cancelLabel: 'Clear'
        }
    });
    $('input[name="homePage-input-search_slider"]').on('apply.daterangepicker', function (ev, picker) {
        $(this).val(picker.startDate.format('MM/DD/YYYY') + ' - ' + picker.endDate.format('MM/DD/YYYY'));
    });
    $('input[name="homePage-input-search_slider"]').on('cancel.daterangepicker', function (ev, picker) {
        $(this).val('');
    });
    ...
    // Styles ------------------
    if ($("footer.homePage-footer").hasClass("fixed-footer")) {
        $('<div class="height-emulator fl-wrap"></div>').appendTo("#homePage");
    }
    function csselem() {
        $(".height-emulator").css({
    ...
    $(".nav-button-wrap").on("click", function () {
        $(".homePage-menu").toggleClass("vismobmenu");
    });
    function mobMenuInit() {
        var ww = $(window).width();
        if (ww < 1064) {
            $(".menusb").remove();
            $(".homePage-menu").removeClass("nav-holder");
            $(".homePage-menu nav").clone().addClass("menusb").appendTo(".homePage-menu");
            $(".menusb").menu();
            ...
            $(".menusb").remove();
            $(".homePage-menu").addClass("nav-holder");
            $(".map-container.fw-map.big_map.hid-mob-map").css({
                height: 550 + "px"
            });
        }
