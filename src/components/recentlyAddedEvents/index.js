    ...
    if (this.props.processing) {
      ...
      if (isNullOrEmpty(event)) {
        ...
        this.mainSliderSettings.infinite =
          event.length > this.mainSliderSettings.slidesToShow;
        buttonSettings.display =
          this.state.width > 1024
            ? this.props.upcomingEventsHome.length >
              this.mainSliderSettings.slidesToShow
            : true;
                ...
                {event.map((card, i) => {
                  ...
                  if (this.props.auth) {
                    wishListFlag =
                      ...
                      this.props.wishLists !== "" &&
                      this.props.wishLists.includes(card.eventSlotId);
                  }
                  return (
                    <React.Fragment key={i}>
                      <DefaultCard
                        ...
                        description={
                          card.parentEventInfo
                            ? card.parentEventInfo.description
                            : []
                        }
                        id={card._id}
                      />
