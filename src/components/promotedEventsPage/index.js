  ...
  render() {
    ...
    if (this.props.promotedEvents) {
      if (this.state.totalPages === 0) {
        this.setState({
          totalPages: this.props.promotedEvents.promotedEvents.totalPages,
        });
      }
    }
    ...
    let promotedEvents =
      this.props.promotedEvents && this.props.promotedEvents.promotedEvents;
    const cardDisplayJSX =
      promotedEvents &&
      Array.isArray(promotedEvents.data) &&
      promotedEvents.data.map((data, i) => {
        shareUrl =
    ...
    let hasPromotedEvents = Boolean(
      promotedEvents && promotedEvents.data && promotedEvents.data.length
    );
    return (
