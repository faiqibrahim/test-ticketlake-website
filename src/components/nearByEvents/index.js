                          ...
                          <div className="container custom-container nearbyLayout">
                              <div className={"row"}>
                                  <div className={"col-md-6 pt-30 mh-100vh pb-30 hide-scrollbar"}>
                                      ...
                                      <div className="col-md-12 list-view-wrp pl-0 pr-0">
                                          {this.state.isloadedNearby ? (
                                              this.state.nearByData.map((data, i) => {
                                                  return (
                                                      <div
                                                          key={i}
                                                          className="row cursor-pointer padding-bottom pt-15 mt-30 hover-effect"
                                                          onClick={() =>
                                                      ...
                                                      >
                                                          <div className="col-md-5 nearby-img">
                                                              <img style={{height: "130px"}}
                                                                   src={data.bannerImageKey.imageUrl} alt='img'/>
                                                          </div>
