...
class EventDetail extends Component {
  ...
  getEventListingState = () => {
    let categoryState = JSON.parse(sessionStorage.getItem("eventsListing"));
    ...
    sessionStorage.setItem("eventsListing", JSON.stringify(categoryState));
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.singleEventDetail && nextProps.singleEventDetail.sections) {
      if (this.state.labelArray !== nextProps.singleEventDetail.sections) {
        this.setState({
          labelArray: this.getGroupBySections(
            nextProps.singleEventDetail.sections,
            true
          ),
          date: getDateFromISO(
            nextProps.singleEventDetail.eventDateTimeSlot.eventStartTime
          ),
          time: getTimeFromISO(
            nextProps.singleEventDetail.eventDateTimeSlot.eventStartTime
          ),
      ...
      return (
        <div>
          {list.map((data) => {
            return (
              <div
                className="list-single-main-item fl-wrap pl-40 custom-section"
                id="sec3"
              >
                <div
                ...
                >
                  <h3 style={{ textTransform: "capitalize", fontSize: "22px" }}>
                    {data.label}
                  </h3>
                </div>
    ...
    if (typeof dataArray !== "undefined") {
      for (let i = 0; i < dataArray.length; i++) {
        if (!dateAlreadyExists(uniqueDates, dataArray[i])) {
          uniqueDates.push(
            dateSplitter(dataArray[i].eventDateTimeSlot.eventStartTime)
          );
        }
      }
    }
  ...
  getTimeForDate = (array, date) => {
    ...
    if (typeof array !== "undefined") {
      for (let i = 0; i < array.length; i++) {
        let dateInArray = dateSplitter(
          array[i].eventDateTimeSlot.eventStartTime
        );
        if (date && date === dateInArray) {
          timeForDate.push(
            getTimeFromISO(array[i].eventDateTimeSlot.eventStartTime)
          );
        }
      }
    }
        ...
        if (item) {
          if (item.hasOwnProperty("imageUrl")) {
            arrangeImages.push({
              ...
              tags: getTags(
                event.parentEventInfo && event.parentEventInfo.tags
              ),
            });
          }
        }
  ...
  getForm = () => {
    ...
    if (!this.props.processing && this.props.singleEventDetail) {
      ...
      if (events) {
        ...
        eventsArray = allEvents ? [...allEvents] : [];
      }
      ...
      let timeForDate = this.getTimeForDate(
        data && data.relatedEvents,
        dateSplitter(eventStartTime)
      );

      dateTimeArray = this.getDateTime(
        getDateFromISO(eventStartTime),
        getTimeFromISO(eventStartTime),
        uniqueDatesForDropDown,
        timeForDate
      );
      ...
      let bannerImage =
        data.bannerImageKey && data.bannerImageKey.imageUrl
          ? data.bannerImageKey.imageUrl
          : window.location.origin + "/images/banner_1.png";
      ...
      return (
        <>
          ...
          >
            <ModalHeader toggle={this.sharingSocial}>
              {data.eventTitle}
            </ModalHeader>
            <ModalBody>
          ...
          <div id="wrapper">
            <div className="content">
                    ...
                    <div className="row">
                      <div className="col-md-12">
                        ...
                        <h2 style={{ marginBottom: "0" }}>
                          <span>
                            {data.eventTitle ? data.eventTitle : "Event Title"}
                          </span>
                        </h2>
                        <p
                          style={{
                        ...
                        >
                          {this.props.singleEventDetail !== null &&
                          this.props.singleEventDetail.categories.length > 0
                            ? this.props.singleEventDetail.categories &&
                              this.props.singleEventDetail.categories.map(
                                (category, i) => {
                                  return (
                        ...
                        <div className="list-single-header-contacts detailImagesIcons fl-wrap">
                          <ul>
                            ...
                            <li>
                              ...
                              <a href={hrefLink}>
                                {data.parentEventInfo
                                  ? data.parentEventInfo.contactPersonInfo.email
                                  : "Email"}
                              </a>
                            </li>
                            <li>
                              <img
                                ...
                                src={
                                  window.location.origin +
                                  "/images/icons/adress.svg"
                                }
                                alt="img"
                              />
                              <a href={hrefLink}>
                                {data.venue ? data.venue.address : "Address"}
                              </a>
                            </li>
                          </ul>
                            ...
                            {this.props.auth ? (
                              isWishlist === true ? (
                                <span
                                  ...
                                  onClick={() =>
                                    wishListToggle(data.eventSlotId, true)
                                  }
                                >
                                ...
                                <span
                                  className={"social-icon"}
                                  onClick={() =>
                                    wishListToggle(data.eventSlotId)
                                  }
                                >
              ...
              <section
                className="grey-blue-bg small-padding scroll-nav-container"
                id="sec2"
              >
                  ...
                  <div className="container custom-container">
                    <nav className="scroll-nav scroll-init">
                      <ul className={"ulEventDetail"}>
                        <li>
                          <a className="act-scrlink" href={hrefLink}>
                            Overview
                          </a>
                        </li>
                ...
                <div className="container custom-container">
                  <div className="row">
                    <div className="col-lg-8 col-md-12 col-sm-12">
                      <div
                        className="list-single-main-container "
                      ...
                      >
                        ...
                        {data.agenda ? (
                          <div className={"agenda-section"} id={"agenda"}>
                            <div
                              className="list-single-main-item fl-wrap pl-40"
                      ...
                      <div className="box-widget-wrap">
                        ...
                        >
                          <div className={"box-widget-content"}>
                            ...
                            {data.parentEventInfo &&
                            data.parentEventInfo.eventType === `${RECUR}` &&
                            uniqueDatesForDropDown.length ? (
                              <>
                                      ...
                                      <div className={"col-md-12"}>
                                        <div className={"row"}>
                                          {this.state.timeArray &&
                                            this.state.timeArray.map(
                                              (timeArray, index) => {
                                                return (
                                                  <div
                                                    key={index}
                                                    className={
                                                      "col-md-3 col-sm-4 col-lg-6 col-xl-3"
                                                    }
                                                    style={{ marginTop: "8px" }}
                                                  >
                                                    {timeArray.click ===
                                ...
                                >
                                  {`${
                                    data.parentEventInfo
                                      .eventMaximumTicketClassPrice === 0
                                      ? "Get Now"
                                      : "Buy Now"
                                  }`}
                                </NavLink>
                            ...
                            <div className="box-widget-content">
                              ...
                              <div className="list-widget-social">
                                <ul>
                                  <li>
                                    <a
                                      href="https://www.facebook.com/ticketlake/?modal=admin_todo_tour"
                                      target="_blank"
                                  ...
                                  <li>
                                    <a
                                      href="https://twitter.com/ticketlake"
                                      target="_blank"
                                      rel="noopener noreferrer"
                                    >
                                  ...
                                  <li>
                                    <a
                                      href="https://www.instagram.com/ticketlake_official/"
                                      target="_blank"
                                      rel="noopener noreferrer"
                                    >
                ...
                {parentEventInfo &&
                (parentEventInfo.eventType === `${SERIES}` ||
                  parentEventInfo.eventType === `${RECUR}`)
                  ? data.relatedEvents && data.relatedEvents.length > 0
                    ? this.getRelatedEvents(data.relatedEvents, data._id)
                    : null
                  : parentEventInfo &&
                    parentEventInfo.eventType === `${STANDARD_EVENT}` &&
                    eventsArray &&
...
const mapStateToProps = (state) => {
  return {
    singleEventDetail:
      state.event.singleEventDetail !== null
        ? state.event.singleEventDetail.data.data
        : null,
