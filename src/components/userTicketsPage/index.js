...
class Tickets extends Component {
  ...
  loadMoreTickets = (e) => {
    ...
    if (
      this.props.ticketPagination &&
      this.props.ticketPagination.hasNextPage === true
    ) {
  ...
  getFilters = () => {
    return (
      <div className={"row justify-content-end"}>
        <div
          className="col-lg-4 col-md-12 offset-lg-3"
  ...
  handlePreviewDownload = (data, isPreview = false) => {
    ...
    localAxios
      .get(`${FILE_URL}api/v1/tickets/get-ticket-pdf/${data._id}`, options)
      .then((res) => {
  ...
  getData = () => {
    return (
      <>
        ...
        this.props.allTickets.length === 0 ? (
          <tbody>
            <tr>
              ...
              <tbody key={i} style={{ textAlign: "left" }}>
                <tr key={i}>
                  ...
                  <td>
                    <span
                      style={spanStyle}
                      onClick={() => this.handlePreviewDownload(data, true)}
                    >
                      Preview
                    </span>
                    <span style={{ color: "#EC1C24", padding: "0px 4px" }}>
                      |
                    </span>
                    <span
                      style={spanStyle}
                      onClick={() => this.handlePreviewDownload(data)}
                    >
                      Download
                    </span>
                  </td>
            ...
            <div className="dashboard-content fl-wrap">
              ...
              <div className="list-single-facts fl-wrap">
                <div className="inline-facts-wrap text-left profile-tic-box">
                  <div className="inline-facts">
                    <div className="milestone-counter">
                      <div className="stats animaper">My Tickets</div>
                    </div>
                    <br />
                ...
                <div className="inline-facts-wrap text-left profile-tic-box">
                  <div className="inline-facts">
                    <div className="milestone-counter">
                      <div className="stats animaper">Guest Tickets</div>
                    </div>
                    <br />
              ...
              <div
                className="list-single-facts fl-wrap"
                style={{ backgroundColor: "transparent" }}
              >
                <div className="box-widget-item-header">
                  <div className={"row"}>
                    <div className={"col-lg-4 col-md-12"}>
                      <h3 style={{ marginTop: "14%", color: "black" }}>
                        Purchased Tickets
                      </h3>
                    </div>
              ...
              this.props.ticketPagination.hasNextPage === true ? (
                <a
                  ...
                  href={hrefVal}
                  onClick={(e) => this.loadMoreTickets(e)}
                >
                  Load more
  ...
  render() {
    ...
    breadCrumbs.push(
      <BreadcrumbsItem to="/user/ticket" key={2}>
        User Ticket
      </BreadcrumbsItem>
    );
    const { ticketPagination = {}, userWallet } = this.props;
