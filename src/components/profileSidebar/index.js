...
import {getAllTickets, logout, setProfilePic} from '../../redux/user/user-actions';
...
class ProfileSidebar extends Component {
    ...
    getForm = () => {
        ...
        let totalDocs;
        let filteredNumber = this.convertNumberValue(wallet.availableBalance);
        let walletBalance = wallet && wallet.availableBalance ? `${wallet.currency + filteredNumber}` : "GHS 0.00";
        ...
        return (
            <div className="dasboard-sidebar">
                <div className="dasboard-sidebar-content fl-wrap">
                        ...
                        <div className={"dashboard-avatar-wrp"}>
                            ...
                            <div className={"img-btn-wrp"}>
                                ...
                                <a href="dashboard-add-listing.html"
                                   ...
                                   className="ed-btn change-img-btn">Change image
                                </a>
                            </div>
                        </div>
                    ...
                    <div className="user-stats fl-wrap">
                        <ul>
                            ...
                            <li>
                                ...
                                <span className={"user-stats-value"}>{ticketPagination && ticketPagination.totalDocs}</span>
                            </li>
                            <li>
                    ...
                    <a href={hrefLink} className="log-out-btn" onClick={this.logoutUser}
                       style={{backgroundColor: 'black', color: "#fff"}}>Log Out <i
...
const connectedComponent = connect(mapStateToProps, {setProfilePic, getAllTickets, logout})(ProfileSidebar);
