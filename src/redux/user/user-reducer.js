import {
    ...
    VERIFY_CODE_ERROR, SET_REDIRECT_TO,
    SET_USER_WALLET, RESET_REDUX_KEY, SET_EVENTS_COUNTRY, SET_BACK_URL,
...
const reducer = (state = initState(), action) => {
    ...
    switch (action.type) {
        ...
        case SET_USER_CALENDAR_EVENTS:
            setUserCalendarEvents(newState, action.payload);
            break;
...
const setUserCalendarEvents = (state, data)=>{
    state.userCalendarEvents = data;
};
