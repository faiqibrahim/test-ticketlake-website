                ...
                <BrowserRouter>
                    <ScrollToTop>
                        ...
                        <div id="main">
                            ...
                            <VerifyEmail />
                            <Switch>
                                <Route path="/organisers" name={"Organisers"} component={Organisers}/>
                                ...
                                <Route path="/successfull/" name={"SuccessPage"} component={SuccessPage}/>
                                <Route path="/failure/" name={"FailurePage"} component={FailurePage}/>
                                <Route path="/contact-us" name={"ContactUs"} component={ContactUsPage}/>
                                <Route path="/about-us" name={"AboutUs"} component={AboutUsPage}/>
                                <Route path="/voting" name={"Voting"} component={VotingRouteWrapper}/>
                                ...
                                <Route path="/user/calendar-events" name={"CalendarEvents"} component={CalendarEvents}/>
                                <Route path="/event/detail/:id" name={"EventDetail"} component={EventDetail}/>
                                <Route path="/movie/detail/:id" name={"MovieDetail"} component={MovieDetail}/>
                                <Route path="/movies/sub-category" name={"ViewMore"} component={ViewMore}/>
                                <Route path="/movies/viewMore" name={"ViewMore"} component={ViewMore}/>
                                <Route path="/movies" name={"Movies"} component={Movies}/>
                                <Route path="/sports" name={"Sports"} component={Sports}/>
                                <Route path="/policies" name={"Sports"} component={PrivacyPolicy}/>
                                <Route path="/terms" name={"Sports"} component={Terms}/>
                                <Route path="/sports" name={"Sports"} component={Sports}/>
                                <Route path="/events/promoted" name={"PromotedEvents"} component={PromotedEvents}/>
                                <Route path="/events/nearby-events" name={"NearByEvents"} component={NearByEvents}/>
                                <Route path="/events/nearby-cinemas/detail/:id" name={"NearByCinemaDetail"} component={NearByCinemaDetail}/>
                                <Route path="/events/nearby-cinemas" name={"NearByCinemas"} component={NearByCinemas}/>
